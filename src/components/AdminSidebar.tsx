...
const AdminSidebar: React.FC<SidebarProps> = ({ collapsed = false, className = '' }) => {
    ...
    >
      <div className="h-full flex flex-col">
        ...
        <nav className="flex-1 px-2 py-3">
          {/* Dashboard */}
          <NavLink to="/admin" className={({ isActive }) => navItemClass(isActive)} end title="Dashboard"> {/* <-- title added */}
          ...
          >
            ...
            <NavLink to="/admin/users/agentsBrokersBuilders" className={({ isActive }) => subItemClass(isActive)}>Agents / Brokers / Builders</NavLink>
